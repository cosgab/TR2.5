...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    <button class="w3-button" title="Notifications">Attività <i class="fa fa-caret-down"></i></button>     
    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
      <a href="#team" class="w3-bar-item w3-button">Periodo presenze</a>
      <a href="#pricing" class="w3-bar-item w3-button">Fogli presenze</a>
      <a href="#contact" class="w3-bar-item w3-button">Verifica budget</a>
    </div>
  </div>  
  <div class="w3-dropdown-hover w3-hide-small">
    <button class="w3-button" title="Notifications">Paghe <i class="fa fa-caret-down"></i></button>     
    <div class="w3-dropdown-content w3-card-4 w3-bar-block">
      <a href="#" class="w3-bar-item w3-button">Invio presenze a Ranoccchi</a>
      <a href="#" class="w3-bar-item w3-button">Verifica congruenza</a>
      <a href="#" class="w3-bar-item w3-button">Link</a>
    </div>
  </div>
  <a href="#contact" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Integrazione</a>
    <div class="w3-dropdown-hover w3-hide-small">
